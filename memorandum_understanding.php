        ...
        <section class="inner_page_slider position-relative">
            <div class="" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block text-white">
                    <h1 class="fs-45 mb-5 fw-bolder mb-0 text-uppercase">Memorandum of Understanding</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="card position-relative shadow border-0">
                            ...
                            <div class="card-body white_box">
                                <div class="detail_text mb-5">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">What is a Memorandum of Understanding (MOU)?</h5>
                                    <p class="card-text fs-15 text-justify show_detail_five_line black_text mb-4">
                                    An Memorandum of Understanding(MOU), which is a legal document that describes an agreement between two or more parties or institutions. It indicates an intended common line of action, rather than a legal commitment. MOUs are not legally binding, but they serve to document each collaborator's expectations or intentions. An MOU is generally Notarized.
                                    </p>
                                </div>
