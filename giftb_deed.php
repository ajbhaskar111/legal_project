        ...
        <section class="inner_page_slider position-relative">
            <div class="" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block text-white">
                    <h1 class="fs-45 mb-5 fw-bolder mb-0 text-uppercase">Giftb deed</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="card position-relative shadow border-0">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <p class="primary_color fs-14 mb-0 p-3">May 16, 2023</p>
                                </div>
                            </div>
                            <img src="assets/media/blog_img.png" class="card-img-top" alt="..." />
                            <div class="card-body white_box">
                                <div class="detail_text mb-5">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">What is a Gift Deed?</h5>
                                    <p class="card-text fs-15 text-justify show_detail_five_line black_text mb-4">
                                    A Gift deed is a legal document by which a property owner can transfer ownership of his/her property to another person as a gift without any consideration. 
                                    </p>
                                </div>
                                <div class="detail_text mb-5">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">Why Gift Deed?</h5>
                                    <p class="card-text fs-15 text-justify show_detail_five_line black_text mb-4">
                                    Gift Deed is generally made by property owners to transfer the property to their relatives. Further, gift deed attracts lesser Stamp Duty if property is transferred to close relatives as mentioned in The Maharashtra Stamp Act, 1958.
                                    </p>
                                </div>
                              
                                <div class="detail_text mb-5 ">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">What  are the essential clauses of a Gift Deed?</h5>
                                    <ul class="listing hadding_list">
                                        <li><a href="" class="fs-15 black_text text-decoration-none">The place and date on which the gift deed is to be executed.</a></li>
                                        <li><a href="" class="fs-15 black_text text-decoration-none">Relevant information on gift deed regarding the donor and the donee, such as their names, address, relationship, date of birth and signatures.</a></li>
                                        <li><a href="" class="fs-15 black_text text-decoration-none">Complete details about the property to be Gifted.</a></li>
                                        <li><a href="" class="fs-15 black_text text-decoration-none">Two witnesses to bear testimony of the gift deed and their signatures. </a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="card position-relative shadow border-0">
                            <div class="">
                                ...
                                <h4 class="card-title fw-700 pt-4 text-center mb-4">Contact with us before you Buy your Property</h4>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn site_black_btn primary_color text-capitalize fs-15 bg_site_black fw-700 w-100">submit request</button>
                                    </div>
                                </form>
                            </div>
                        </div>
