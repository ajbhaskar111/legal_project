        ...
        <section class="inner_page_slider position-relative">
            <div class="" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block text-white">
                    <h1 class="fs-45 mb-5 fw-bolder mb-0 text-uppercase">Will</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="card position-relative shadow border-0">
                            ...
                            <div class="card-body white_box">
                                <div class="detail_text mb-5">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">What is Will?</h5>
                                    <p class="card-text fs-15 text-justify show_detail_five_line black_text mb-4">
                                    A will is a legal document that states how a person's assets should be distributed after their death. The person who writes the will is called the testator. The Indian Succession Act of 1925 governs the execution of wills in India.
                                    </p>
                                </div>
                              
                                <div class="detail_text mb-5 ">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">What are the types of Will?</h5>
                                    <ul class="listing hadding_list">
                                        <li><span class="fs-15 black_text text-decoration-none">Privileged Will </span></li>
                                        <li><span class="fs-15 black_text text-decoration-none">Unprivileged Will </span></li>
                                        <li><span class="fs-15 black_text text-decoration-none">Conditional Will</span></li>
                                        <li><span class="fs-15 black_text text-decoration-none">Concurrent Will </span></li>
                                        <li><span class="fs-15 black_text text-decoration-none">Mutual Will</span></li>
                                    </ul>
                                </div>
                                <div class="detail_text mb-5 ">
                                    <h5 class="primary_color mb-4 mt-3 three_line_show">Who can make a Will?</h5>
                                    <ul class="listing hadding_list">
                                        <li><span class="fs-15 black_text text-decoration-none">Every person of sound mind not being a minor may make Will.</span></li>
                                        <li><span class="fs-15 black_text text-decoration-none">Person must be the owner of the property  and/or right which he intends to transfer.</span></li>
